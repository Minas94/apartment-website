...
const T = {
  en: {
    ...
    guide: {
      ...
      sections:[
        { id:"rules",     icon:"📋", title:"House Rules",             text:"No smoking inside · No parties · Quiet hours 22:00–08:00 · Do not move furniture to other rooms · Report any damage immediately." },
        { id:"checkin",   icon:"🔑", title:"Check-in & Check-out",   text:"Check-in is fully automated from 4:00 PM — your personal access code will be sent to you before arrival, no key collection needed. Check-out is by 11:00 AM. If you are arriving early or need a late check-out, please let us know in advance and we will do everything in our power to accommodate." },
        { id:"market",    icon:"🛒", title:"Saturday Market",           text:"Every Saturday a street market takes place on Viale Italia — the road leading to the apartment's main entrance — from 08:00 to 14:00. During this time it is not possible to enter by car through the main gate. You can exit via the secondary gate, but the street is one-way so you cannot re-enter until the market ends." },
        { id:"wifi",      icon:"📶", title:"Wi-Fi & Internet",        text:"Network: vodafone lisoladoro · Password will be provided at check-in." },
        { id:"aircon",    icon:"❄️",  title:"Air Conditioning",       text:"One remote controls both splits — point it at the unit you want to control and press the desired button. Works for both cooling and heating." },
        { id:"tv",        icon:"📺", title:"TV & Entertainment",      text:"The TV runs on Google TV. You can log in to your preferred streaming service — please remember to log out before check-out. A PS2 is also available but currently not functioning (adaptor not yet found)." },
        { id:"kitchen",   icon:"🍳", title:"Kitchen & Appliances",    text:"The apartment has two kitchens — an indoor kitchen with a gas hob, and an outdoor kitchen on the terrace with an electric hob. All basic kitchen appliances are provided, including a coffee machine. Coffee and pantry essentials included." },
        { id:"dishwasher",icon:"🍽", title:"Dishwasher",              text:"In the kitchen. Add tablet to the dispenser compartment, close and latch the door, select Eco 50° for a normal load, press Start. Tablets and rinse aid under the sink. Please note: pans and cookware must be washed by hand — do not put them in the dishwasher." },
        { id:"stove",     icon:"🪵", title:"Pellet Stove",            text:"For winter use only. Pellets and operating instructions will be provided by us." },
        { id:"washing",   icon:"🫧", title:"Washing Machine",         text:"Located on the terrace. Detergent stored nearby. Standard 40° cycle: press Cotton, set 40°, press Start. Please do not run the washing machine during quiet hours (22:00–08:00)." },
        { id:"mosquito",  icon:"🦟", title:"Mosquitoes",               text:"The apartment is equipped with mosquito nets in all rooms except the veranda. Repellent coils are provided for terrace dining. An electric repellent plug-in is also provided in the drawer of each bedroom to help improve sleep quality. Please do not squash mosquitoes on the walls." },
        { id:"books",     icon:"📚", title:"Books & Board Games",      text:"You'll find a small collection of books and board games — feel free to enjoy them during your stay or take a book to the beach. Before you check out, please return everything to its place so the next guests can enjoy them too. We'd love for them to stay part of the apartment." },
        { id:"garbage",   icon:"🗑", title:"Waste Disposal",           text:"From this year the municipality has introduced a new waste disposal system. You will need the card provided at check-in to open the bins. Bins are located just 1 minute down the road." },
        { id:"emergency", icon:"🆘", title:"Emergencies",             text:"Emergency: 112 · Host: +41 76 242 88 95 · Nearest hospital: Ospedale di Grado, Via Monfalcone 14 · Nearest pharmacy: Farmacia Centrale, Piazza Biagio Marin." },
      ],
    },
    neighborhood: {
      title:"Local Guide",
      ...
      places:[
        ...
        { cat:"Activities",   name:"Tennis & Padel Club",             text:"The local tennis club, just a short walk from the apartment. Courts available for hire — a great way to spend an active morning or afternoon.", map:"https://maps.app.goo.gl/CkcajDeHWeZZJ1Pa6" },
    ...
    findus: {
      ...
      directions:[
        { how:"By Car",   text:"From Trieste: A4 motorway towards Venice, exit Palmanova, then follow signs to Grado (~1 hr). From Venice: A4 east, exit Latisana, follow signs to Grado (~1.5 hr). Private parking is provided for free." },
        ...
        { how:"By Plane", text:"Venice Marco Polo Airport (VCE): ~1.5 hr by car or bus+train. Trieste Airport (TRS): ~45 min by car — the most convenient option if flying in." },
      ],
  ...
  it: {
    ...
    guide: {
      ...
      sections:[
        { id:"rules",     icon:"📋", title:"Regole della Casa",        text:"Vietato fumare all'interno · Vietato organizzare feste · Silenzio dalle 22:00 alle 08:00 · Non spostare i mobili · Segnalare subito eventuali danni." },
        { id:"checkin",   icon:"🔑", title:"Check-in e Check-out",     text:"Il check-in è completamente automatizzato a partire dalle 16:00 — il tuo codice di accesso personale ti verrà inviato prima dell'arrivo, senza bisogno di ritirare le chiavi. Il check-out è entro le 11:00. Per arrivi anticipati o check-out tardivi, contattaci in anticipo e faremo di tutto per accontentarti." },
        { id:"market",    icon:"🛒", title:"Mercato del Sabato",        text:"Ogni sabato, dalle 08:00 alle 14:00, si svolge un mercato su Viale Italia — la strada che porta all'ingresso principale dell'appartamento. Durante questo orario non è possibile entrare in auto dal cancello principale. È possibile uscire dal cancello secondario, ma essendo una strada a senso unico non si può rientrare fino al termine del mercato." },
        { id:"wifi",      icon:"📶", title:"Wi-Fi e Internet",          text:"Rete: vodafone lisoladoro · La password verrà fornita al check-in." },
        { id:"aircon",    icon:"❄️",  title:"Aria Condizionata",        text:"Un solo telecomando controlla entrambi i split — puntalo verso l'unità che vuoi controllare e premi il tasto desiderato. Funziona sia per il raffreddamento che per il riscaldamento." },
        { id:"tv",        icon:"📺", title:"TV e Intrattenimento",      text:"Il TV funziona con Google TV. Puoi accedere al tuo servizio di streaming preferito — ricordati di effettuare il logout prima del check-out. È disponibile anche un PS2, ma al momento non funziona (adattatore non ancora trovato)." },
        { id:"kitchen",   icon:"🍳", title:"Cucina ed Elettrodomestici",text:"L'appartamento dispone di due cucine — una interna con piano cottura a gas e una esterna sulla terrazza con piano cottura elettrico. Tutti gli elettrodomestici di base sono disponibili, inclusa una macchina del caffè. Caffè e prodotti di base inclusi." },
        { id:"dishwasher",icon:"🍽", title:"Lavastoviglie",             text:"In cucina. Inserire la pastiglia nel vano dosatore, chiudere e bloccare lo sportello, selezionare Eco 50° per un carico normale, premere Start. Pastiglie e brillantante sotto il lavandino. Attenzione: pentole e tegami devono essere lavati a mano — non vanno in lavastoviglie." },
        { id:"stove",     icon:"🪵", title:"Stufa a Pellet",            text:"Solo per uso invernale. Pellet e istruzioni per l'uso verranno forniti da noi." },
        { id:"washing",   icon:"🫧", title:"Lavatrice",                 text:"Si trova sulla terrazza. Detersivo riposto nelle vicinanze. Ciclo standard 40°: premere Cotone, impostare 40°, premere Start. Si prega di non avviare la lavatrice durante le ore di silenzio (22:00–08:00)." },
        { id:"mosquito",  icon:"🦟", title:"Zanzare",                  text:"L'appartamento è dotato di zanzariere in tutte le stanze tranne la veranda. Sono forniti dei repellenti da esterno da accendere per le cene in terrazza. In ogni cassetto delle camere da letto è disponibile anche un repellente elettrico per migliorare la qualità del sonno. Si prega di non schiacciare le zanzare sulle pareti." },
        { id:"books",     icon:"📚", title:"Libri e Giochi da Tavolo",  text:"Troverai una piccola raccolta di libri e giochi da tavolo — sentiti libero di usarli durante il soggiorno o di portare un libro in spiaggia. Prima del check-out, ti chiediamo gentilmente di rimettere tutto al suo posto così che anche i prossimi ospiti possano goderne. Ci piacerebbe che restassero parte dell'appartamento." },
        { id:"garbage",   icon:"🗑", title:"Smaltimento Rifiuti",      text:"Da quest'anno il Comune ha introdotto un nuovo sistema di smaltimento rifiuti. Sarà necessaria la card fornita al check-in per aprire i bidoni. I bidoni si trovano a 1 minuto a piedi." },
        { id:"emergency", icon:"🆘", title:"Emergenze",                text:"Emergenze: 112 · Host: +41 76 242 88 95 · Ospedale di Grado, Via Monfalcone 14 · Farmacia Centrale, Piazza Biagio Marin." },
      ],
    },
    neighborhood: {
      title:"Guida Locale",
      ...
      places:[
        ...
        { cat:"Attività",       name:"Tennis & Padel Club",            text:"Il circolo tennistico locale, a pochi minuti a piedi dall'appartamento. Campi disponibili a noleggio — un ottimo modo per trascorrere una mattina o un pomeriggio all'aria aperta.", map:"https://maps.app.goo.gl/CkcajDeHWeZZJ1Pa6" },
    ...
    findus: {
      ...
      directions:[
        { how:"In Auto",   text:"Da Trieste: autostrada A4 verso Venezia, uscita Palmanova, poi seguire le indicazioni per Grado (~1 ora). Da Venezia: A4 est, uscita Latisana (~1,5 ore). Parcheggio privato fornito gratuitamente." },
        ...
        { how:"In Aereo",  text:"Aeroporto di Venezia Marco Polo (VCE): ~1,5 ore in auto o con bus+treno. Aeroporto di Trieste (TRS): ~45 min in auto — l'opzione più comoda se si arriva in aereo." },
      ],
  ...
  de: {
    ...
    guide: {
      ...
      sections:[
        { id:"rules",     icon:"📋", title:"Hausregeln",                 text:"Kein Rauchen im Inneren · Keine Partys · Ruhezeiten 22:00–08:00 · Möbel nicht verschieben · Schäden sofort melden." },
        { id:"checkin",   icon:"🔑", title:"Check-in & Check-out",       text:"Der Check-in ist ab 16:00 Uhr vollständig automatisiert — Ihr persönlicher Zugangscode wird Ihnen vor der Ankunft zugesandt, keine Schlüsselabholung nötig. Check-out bis 11:00 Uhr. Bei früher Ankunft oder spätem Check-out bitte vorab Bescheid geben — wir tun unser Bestes, um entgegenzukommen." },
        { id:"market",    icon:"🛒", title:"Samstagmarkt",               text:"Jeden Samstag findet von 08:00 bis 14:00 Uhr ein Straßenmarkt auf der Viale Italia statt — der Straße, die zum Haupteingang der Wohnung führt. In dieser Zeit ist es nicht möglich, mit dem Auto durch das Haupttor einzufahren. Die Ausfahrt über das Nebentor ist möglich, aber da es sich um eine Einbahnstraße handelt, kann man erst nach Marktende wieder einfahren." },
        { id:"wifi",      icon:"📶", title:"Wi-Fi & Internet",            text:"Netzwerk: vodafone lisoladoro · Passwort wird beim Check-in mitgeteilt." },
        { id:"aircon",    icon:"❄️",  title:"Klimaanlage",                text:"Eine Fernbedienung steuert beide Splits — auf das gewünschte Gerät richten und die entsprechende Taste drücken. Funktioniert zum Kühlen und zum Heizen." },
        { id:"tv",        icon:"📺", title:"Fernseher",                   text:"Der Fernseher läuft mit Google TV. Sie können sich bei Ihrem bevorzugten Streaming-Dienst anmelden — bitte vor dem Check-out abmelden. Eine PS2 ist vorhanden, funktioniert aber derzeit nicht (Adapter noch nicht gefunden)." },
        { id:"kitchen",   icon:"🍳", title:"Küche & Geräte",             text:"Die Wohnung hat zwei Küchen — eine Innenküche mit Gasherd und eine Außenküche auf der Terrasse mit Elektroherd. Alle grundlegenden Küchengeräte sind vorhanden, darunter eine Kaffeemaschine. Kaffee und Grundvorräte inklusive." },
        { id:"dishwasher",icon:"🍽", title:"Geschirrspüler",             text:"In der Küche. Tab in das Dosierfach geben, Tür schließen und verriegeln, Eco 50° für normale Beladung wählen, Start drücken. Tabs und Klarspüler unter dem Waschbecken. Bitte beachten: Töpfe und Pfannen müssen von Hand gespült werden — nicht in den Geschirrspüler." },
        { id:"stove",     icon:"🪵", title:"Pelletofen",                 text:"Nur für den Winter. Pellets und Bedienungsanleitung werden von uns bereitgestellt." },
        { id:"washing",   icon:"🫧", title:"Waschmaschine",              text:"Auf der Terrasse. Waschmittel in der Nähe. Standardprogramm 40°: Baumwolle wählen, 40° einstellen, Start drücken. Bitte nicht während der Ruhezeiten (22:00–08:00) nutzen." },
        { id:"mosquito",  icon:"🦟", title:"Mücken",                    text:"Die Wohnung ist in allen Zimmern außer der Veranda mit Fliegengittern ausgestattet. Für das Abendessen auf der Terrasse stehen Mückenspiralen bereit, die angezündet werden können. In der Schublade jedes Schlafzimmers liegt auch ein elektrisches Mückenabwehrgerät für eine bessere Schlafqualität. Bitte keine Mücken an die Wände quetschen." },
        { id:"books",     icon:"📚", title:"Bücher & Brettspiele",       text:"Sie finden eine kleine Sammlung an Büchern und Brettspielen — nutzen Sie sie gerne während Ihres Aufenthalts oder nehmen Sie ein Buch mit an den Strand. Bitte legen Sie vor dem Check-out alles wieder an seinen Platz, damit auch die nächsten Gäste etwas davon haben. Wir würden uns freuen, wenn sie Teil der Wohnung bleiben." },
        { id:"garbage",   icon:"🗑", title:"Müllentsorgung",             text:"Ab diesem Jahr hat die Gemeinde ein neues Müllentsorgungssystem eingeführt. Zum Öffnen der Behälter wird die beim Check-in bereitgestellte Karte benötigt. Die Behälter befinden sich 1 Minute zu Fuß entfernt." },
        { id:"emergency", icon:"🆘", title:"Notfälle",                   text:"Notruf: 112 · Gastgeber: +41 76 242 88 95 · Krankenhaus Grado, Via Monfalcone 14 · Farmacia Centrale, Piazza Biagio Marin." },
      ],
    },
    neighborhood: {
      title:"Lokaler Guide",
      ...
      places:[
        ...
        { cat:"Aktivitäten",     name:"Tennis & Padel Club",           text:"Der örtliche Tennisclub, nur wenige Gehminuten von der Wohnung entfernt. Plätze zum Mieten verfügbar — ideal für einen aktiven Morgen oder Nachmittag.", map:"https://maps.app.goo.gl/CkcajDeHWeZZJ1Pa6" },
    ...
    findus: {
      ...
      directions:[
        { how:"Mit dem Auto",  text:"Von Triest: A4 Richtung Venedig, Ausfahrt Palmanova, dann Beschilderung nach Grado (~1 Std). Von Venedig: A4 Ost, Ausfahrt Latisana (~1,5 Std). Privater Parkplatz ist kostenlos inbegriffen." },
        ...
        { how:"Mit dem Flugzeug", text:"Flughafen Venedig Marco Polo (VCE): ~1,5 Std mit dem Auto oder Bus+Zug. Flughafen Triest (TRS): ~45 Min mit dem Auto — die bequemste Option bei Anreise per Flugzeug." },
      ],
  ...
  pl: {
    ...
    guide: {
      ...
      sections:[
        { id:"rules",     icon:"📋", title:"Zasady domu",                 text:"Zakaz palenia w środku · Zakaz imprez · Cisza nocna 22:00–08:00 · Nie przestawiać mebli · Natychmiast zgłaszać szkody." },
        { id:"checkin",   icon:"🔑", title:"Zameldowanie i wymeldowanie", text:"Check-in jest w pełni zautomatyzowany od 16:00 — Twój osobisty kod dostępu zostanie wysłany przed przyjazdem, bez konieczności odbierania kluczy. Check-out do 11:00. W przypadku wcześniejszego przyjazdu lub późnego check-outu, prosimy o wcześniejszy kontakt — zrobimy wszystko, aby się dostosować." },
        { id:"market",    icon:"🛒", title:"Sobotni Targ",                text:"W każdą sobotę od 08:00 do 14:00 na Viale Italia — ulicy prowadzącej do głównego wejścia apartamentu — odbywa się targ. W tym czasie nie można wjechać samochodem przez główną bramę. Można wyjechać bramą boczną, ale ponieważ ulica jest jednokierunkowa, powrót samochodem możliwy jest dopiero po zakończeniu targu." },
        { id:"wifi",      icon:"📶", title:"Wi-Fi i Internet",             text:"Sieć: vodafone lisoladoro · Hasło zostanie podane przy check-in." },
        { id:"aircon",    icon:"❄️",  title:"Klimatyzacja",                text:"Jeden pilot steruje obydwoma unitami — skieruj go na urządzenie, którym chcesz sterować, i naciśnij żądany przycisk. Działa zarówno do chłodzenia, jak i ogrzewania." },
        { id:"tv",        icon:"📺", title:"Telewizor i rozrywka",         text:"Telewizor działa na Google TV. Możesz zalogować się do wybranego serwisu streamingowego — pamiętaj o wylogowaniu przed check-out. Dostępna jest również konsola PS2, ale aktualnie nie działa (brak adaptera)." },
        { id:"kitchen",   icon:"🍳", title:"Kuchnia i sprzęty",           text:"Apartament posiada dwie kuchnie — wewnętrzną z kuchenką gazową i zewnętrzną na tarasie z płytą elektryczną. Dostępne są wszystkie podstawowe urządzenia kuchenne, w tym ekspres do kawy. Kawa i produkty podstawowe w zestawie." },
        { id:"dishwasher",icon:"🍽", title:"Zmywarka",                    text:"W kuchni. Włóż tabletkę do dozownika, zamknij i zablokuj drzwi, wybierz Eco 50° do normalnego wsadu, naciśnij Start. Tabletki i nabłyszczacz pod zlewem. Uwaga: garnki i patelnie należy myć ręcznie — nie wkładać do zmywarki." },
        { id:"stove",     icon:"🪵", title:"Piec na pellet",              text:"Tylko na zimę. Pellet i instrukcja obsługi zostaną dostarczone przez nas." },
        { id:"washing",   icon:"🫧", title:"Pralka",                      text:"Na tarasie. Proszek w pobliżu. Standardowy cykl 40°: wybierz Bawełna, ustaw 40°, naciśnij Start. Prosimy nie uruchamiać pralki w godzinach ciszy (22:00–08:00)." },
        { id:"mosquito",  icon:"🦟", title:"Komary",                    text:"Apartament wyposażony jest w siatki przeciw komarom we wszystkich pokojach z wyjątkiem werandy. Do kolacji na tarasie dostępne są spirale odstraszające, które można zapalić. W szufladzie każdej sypialni dostępny jest też elektryczny odstraszacz komarów poprawiający jakość snu. Prosimy nie rozgniatać komarów na ścianach." },
        { id:"books",     icon:"📚", title:"Książki i Gry Planszowe",    text:"Znajdziesz tu małą kolekcję książek i gier planszowych — możesz z nich korzystać podczas pobytu lub zabrać książkę na plażę. Przed wymeldowaniem prosimy odłożyć wszystko na miejsce, żeby kolejni goście też mogli się nimi cieszyć. Będziemy wdzięczni, jeśli pozostaną częścią apartamentu." },
        { id:"garbage",   icon:"🗑", title:"Wywóz Odpadów",               text:"Od tego roku gmina wprowadziła nowy system wywozu odpadów. Do otwarcia pojemników potrzebna jest karta otrzymana przy check-in. Pojemniki znajdują się 1 minutę drogi od apartamentu." },
        { id:"emergency", icon:"🆘", title:"Sytuacje awaryjne",           text:"Numer alarmowy: 112 · Gospodarz: +41 76 242 88 95 · Szpital w Grado, Via Monfalcone 14." },
      ],
    },
    neighborhood: {
      ...
      places:[
        ...
        { cat:"Aktywności",        name:"Tennis & Padel Club",           text:"Lokalny klub tenisowy, kilka minut spacerem od apartamentu. Korty dostępne do wynajęcia — świetny sposób na aktywny poranek lub popołudnie.", map:"https://maps.app.goo.gl/CkcajDeHWeZZJ1Pa6" },
    ...
    findus: {
      ...
      directions:[
        { how:"Samochodem", text:"Z Triestu: autostrada A4 w kierunku Wenecji, zjazd Palmanova, następnie drogowskazy do Grado (~1 godz). Z Wenecji: A4 na wschód, zjazd Latisana (~1,5 godz). Prywatny parking zapewniony bezpłatnie." },
        ...
        { how:"Samolotem",  text:"Lotnisko Wenecja Marco Polo (VCE): ~1,5 godz samochodem lub autobusem+pociągiem. Lotnisko Triest (TRS): ~45 min samochodem — najwygodniejsza opcja przy przylocie." },
      ],
  ...
  sk: {
    ...
    guide: {
      ...
      sections:[
        { id:"rules",     icon:"📋", title:"Domáci poriadok",            text:"Zákaz fajčenia vo vnútri · Zákaz párty · Nočný kľud 22:00–08:00 · Nepresúvajte nábytok · Nahláste poškodenie okamžite." },
        { id:"checkin",   icon:"🔑", title:"Check-in a check-out",       text:"Check-in je od 16:00 plne automatizovaný — váš osobný prístupový kód vám bude zaslaný pred príchodom, bez potreby vyzdvihnutia kľúčov. Check-out do 11:00. Pri skorom príchode alebo neskorom check-oute nás prosím kontaktujte vopred — urobíme všetko pre to, aby sme vyšli v ústrety." },
        { id:"market",    icon:"🛒", title:"Sobotňajší Trh",             text:"Každú sobotu od 08:00 do 14:00 sa na Viale Italia — ulici vedúcej k hlavnému vchodu apartmánu — koná pouličný trh. Počas tohto času nie je možné vojsť autom cez hlavnú bránu. Vyjsť cez vedľajšiu bránu je možné, no keďže ulica je jednosmerná, návrat autom je možný až po skončení trhu." },
        { id:"wifi",      icon:"📶", title:"Wi-Fi a internet",            text:"Sieť: vodafone lisoladoro · Heslo bude poskytnuté pri check-in." },
        { id:"aircon",    icon:"❄️",  title:"Klimatizácia",               text:"Jedno diaľkové ovládanie ovláda oba split-klimatizátory — namierte ho na jednotku, ktorú chcete ovládať, a stlačte požadované tlačidlo. Funguje na chladenie aj vykurovanie." },
        { id:"tv",        icon:"📺", title:"Televízor",                   text:"Televízor funguje na Google TV. Môžete sa prihlásiť do svojej obľúbenej streamovacej služby — nezabudnite sa odhlásiť pred check-outom. K dispozícii je aj PS2, momentálne však nefunguje (adaptér ešte nebol nájdený)." },
        { id:"kitchen",   icon:"🍳", title:"Kuchyňa a spotrebiče",       text:"Apartmán má dve kuchyne — vnútornú s plynovým sporákom a vonkajšiu na terase s elektrickým sporákom. K dispozícii sú všetky základné kuchynské spotrebiče vrátane kávovaru. Káva a základné zásoby v cene." },
        { id:"dishwasher",icon:"🍽", title:"Umývačka riadu",             text:"V kuchyni. Vložte tabletu do dávkovača, zatvorte a zaistite dvierka, vyberte Eco 50° pre bežnú náplň, stlačte Štart. Tablety a leštidlo pod umývadlom. Upozornenie: hrnce a panvice musia byť umyté ručne — nedávajte ich do umývačky." },
        { id:"stove",     icon:"🪵", title:"Peletový krb",               text:"Len na zimné použitie. Pelety a návod na obsluhu vám poskytneme my." },
        { id:"washing",   icon:"🫧", title:"Práčka",                     text:"Na terase. Prací prášok v blízkosti. Štandardný cyklus 40°: vyberte Bavlna, nastavte 40°, stlačte Štart. Prosím, nespúšťajte práčku počas nočného kľudu (22:00–08:00)." },
        { id:"mosquito",  icon:"🦟", title:"Komáre",                    text:"Apartmán je vybavený sieťkami proti komárom vo všetkých izbách okrem verandy. Na večeru na terase sú k dispozícii repelentné špirály, ktoré je možné zapáliť. V zásuvke každej spálne je tiež elektrický odpudzovač komárov na zlepšenie kvality spánku. Prosíme, nerozmačkávajte komáre na stenách." },
        { id:"books",     icon:"📚", title:"Knihy a Spoločenské Hry",    text:"Nájdete tu malú zbierku kníh a spoločenských hier — pokojne ich využite počas pobytu alebo si vezmite knihu na pláž. Pred odchodom prosíme vráťte všetko na svoje miesto, aby si ich mohli užiť aj ďalší hostia. Budeme radi, ak zostanú súčasťou apartmánu." },
        { id:"garbage",   icon:"🗑", title:"Likvidácia Odpadu",          text:"Od tohto roka obec zaviedla nový systém likvidácie odpadu. Na otvorenie kontajnerov je potrebná karta poskytnutá pri check-in. Kontajnery sa nachádzajú 1 minútu pešo." },
        { id:"emergency", icon:"🆘", title:"Núdzové situácie",           text:"Tiesňové volanie: 112 · Hostiteľ: +41 76 242 88 95 · Nemocnica v Grado, Via Monfalcone 14." },
      ],
    },
    neighborhood: {
      ...
      places:[
        ...
        { cat:"Aktivity",       name:"Tennis & Padel Club",           text:"Miestny tenisový klub, len pár minút pešo od apartmánu. Kurty na prenájom — skvelý spôsob, ako stráviť aktívne ráno alebo popoludnie.", map:"https://maps.app.goo.gl/CkcajDeHWeZZJ1Pa6" },
    ...
    findus: {
      ...
      directions:[
        { how:"Autom",      text:"Z Terstu: diaľnica A4 smer Benátky, výjazd Palmanova, potom smerovky na Grado (~1 hod). Z Benátok: A4 na východ, výjazd Latisana (~1,5 hod). Súkromné parkovanie je poskytnuté bezplatne." },
        ...
        { how:"Lietadlom",  text:"Letisko Benátky Marco Polo (VCE): ~1,5 hod autom alebo autobusom+vlakom. Letisko Terst (TRS): ~45 min autom — najpohodlnejšia možnosť pri prílete." },
      ],
  ...
  hu: {
    ...
    guide: {
      ...
      sections:[
        { id:"rules",     icon:"📋", title:"Házirendek",                    text:"Tilos a dohányzás belül · Partik nem engedélyezettek · Éjszakai csend 22:00–08:00 · Ne mozgassa a bútorokat · A károkat azonnal jelezze." },
        { id:"checkin",   icon:"🔑", title:"Bejelentkezés és kijelentkezés", text:"A bejelentkezés 16:00-tól teljesen automatizált — személyes hozzáférési kódját az érkezés előtt elküldjük, nincs szükség kulcsátvételre. A kijelentkezés 11:00-ig. Korai érkezés vagy késői kijelentkezés esetén kérjük, jelezze előre — mindent megteszünk, hogy alkalmazkodjunk az igényeihez." },
        { id:"market",    icon:"🛒", title:"Szombati Piac",               text:"Minden szombaton 08:00 és 14:00 között utcai piac van a Viale Italián — az apartman főbejáratához vezető úton. Ez idő alatt autóval nem lehet behajtani a főkapun. A mellékkapun ki lehet hajtani, de mivel az utca egyirányú, visszatérni csak a piac végén lehet." },
        { id:"wifi",      icon:"📶", title:"Wi-Fi és internet",              text:"Hálózat: vodafone lisoladoro · A jelszót bejelentkezéskor adjuk meg." },
        { id:"aircon",    icon:"❄️",  title:"Légkondicionáló",               text:"Egy távirányító irányítja mindkét splitklímát — irányítsa a vezérelni kívánt egységre és nyomja meg a kívánt gombot. Hűtésre és fűtésre egyaránt használható." },
        { id:"tv",        icon:"📺", title:"Televízió és szórakozás",        text:"A televízió Google TV-n fut. Bejelentkezhet kedvenc streaming szolgáltatásába — ne felejtsen el kijelentkezni a check-out előtt. PS2 is rendelkezésre áll, de jelenleg nem működik (az adapter még nem került elő)." },
        { id:"kitchen",   icon:"🍳", title:"Konyha és háztartási gépek",    text:"Az apartmannak két konyhája van — egy beltéri gáztűzhellyel és egy kültéri a teraszon villanytűzhellyel. Minden alapvető konyhai eszköz rendelkezésre áll, köztük kávéfőző. Kávé és alapvető élelmiszerek biztosítva." },
        { id:"dishwasher",icon:"🍽", title:"Mosogatógép",                   text:"A konyhában. Tegye a tablettát az adagolóba, csukja be és reteszelje az ajtót, válassza az Eco 50°-os programot normál töltethez, nyomja meg az Indítás gombot. Tabletták és öblítőszer a mosdó alatt. Figyelem: a fazekakat és serpenyőket kézzel kell mosni — ne tegye őket a mosogatógépbe." },
        { id:"stove",     icon:"🪵", title:"Pelletkályha",                   text:"Csak téli használatra. A pelletet és a kezelési útmutatót mi biztosítjuk." },
        { id:"washing",   icon:"🫧", title:"Mosógép",                       text:"A teraszon. Mosószer a közelben. Standard 40°-os ciklus: válassza a Pamut programot, állítsa be a 40°-ot, nyomja meg az Indítás gombot. Kérjük, ne használja a mosógépet az éjszakai csend idején (22:00–08:00)." },
        { id:"mosquito",  icon:"🦟", title:"Szúnyogok",                 text:"Az apartman minden helyiségében szúnyogháló található a veranda kivételével. A teraszon való vacsorázáshoz szúnyogriasztó spirálok állnak rendelkezésre, amelyek meggyújthatók. Minden hálószoba fiókjában elektromos szúnyogriasztó is található az alvás minőségének javítása érdekében. Kérjük, ne nyomja szét a szúnyogokat a falakon." },
        { id:"books",     icon:"📚", title:"Könyvek és Társasjátékok",   text:"Találsz egy kis könyv- és társasjáték-gyűjteményt — bátran használd őket a tartózkodás alatt, vagy vigyél magaddal egy könyvet a strandra. Kijelentkezés előtt kérjük, tedd vissza mindent a helyére, hogy a következő vendégek is örömüket lelhessék bennük. Örülnénk, ha az apartman részei maradnának." },
        { id:"garbage",   icon:"🗑", title:"Hulladékleadás",                text:"Az idén az önkormányzat új hulladékleadási rendszert vezetett be. A tárolók kinyitásához szükség van a bejelentkezéskor kapott kártyára. A tárolók 1 percnyire találhatók." },
        { id:"emergency", icon:"🆘", title:"Vészhelyzetek",                 text:"Segélyhívó: 112 · Házigazda: +41 76 242 88 95 · Grado kórháza, Via Monfalcone 14." },
      ],
    },
    neighborhood: {
      title:"Helyi Kalauz",
      ...
      places:[
        ...
        { cat:"Tevékenységek",     name:"Tennis & Padel Club",           text:"A helyi teniszklub, az apartmantól csak pár perc sétára. Pályák bérelhetők — remek lehetőség egy aktív reggel vagy délután eltöltésére.", map:"https://maps.app.goo.gl/CkcajDeHWeZZJ1Pa6" },
    ...
    findus: {
      ...
      directions:[
        { how:"Autóval",    text:"Triesztből: A4 autópálya Velence felé, Palmanova lehajtó, majd Grado táblák követése (~1 óra). Velencéből: A4 keletre, Latisana lehajtó (~1,5 óra). Ingyenes privát parkoló biztosított." },
        ...
        { how:"Repülővel",  text:"Velence Marco Polo repülőtér (VCE): ~1,5 óra autóval vagy busszal+vonattal. Trieszt repülőtér (TRS): ~45 perc autóval — ez a legkényelmesebb lehetőség repülős érkezéshez." },
      ],
